    ...
    <div class="container relative">
        <div class="row heading-row mb-20">
            <div class="col-md-6 col-md-offset-3 text-center">
                <h2 class="heading white bottom-line">Keranjang</h2>
            </div>
        </div>
    </div>
</section> 
            ...
            <form class="form-cart">
                            ...
                            <table class="shop_table cart table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product-subtotal" colspan="2">Hapus</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($carts as $cart)
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img src="/uploads/{{ $cart->product->foto }}" alt="">
                                                </a>
                                            </td>
                            ...
                            <div class="col-md-7">
                                <div class="actions">
                                    <div class="wc-proceed-to-checkout">
                                        <a href="#" class="btn btn-lg btn-dark checkout"><span>lanjutkan Beli</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 shipping-calculator-form">
                        <h2 class="heading relative uppercase bottom-line full-grey mb-30">hitung ongkir</h2>
                    ...
                    <div class="col-md-6">
                        <div class="cart_totals">
                            <h2 class="heading relative bottom-line full-grey uppercase mb-30">Total Harga</h2>
